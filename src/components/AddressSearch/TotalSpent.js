...
export default class TotalSpent extends Component {
  constructor(props) {
    super(props)
  ...
  GetSpent=async()=>{
    ...
    .then((res)=>{
      this.setState({showModal:true,spent:(res.data)*10**18})
    })
  }
    ...
    return (
      <div style={{textAlign:'center'}}>
        ...
        <div className='main-section d-flex'>
          ...
          <button className='btn btn-info' onClick={()=>this.GetSpent()}>Search</button>
        </div>
          ...
          <div className='modals-content'>
            ...
            <div className='main-content'>
              <label className='d-flex label-text'>
                <h4>Total BTC Spent:</h4>
                <h6>{parseInt(this.state.spent).toFixed(3)}</h6>
              </label>
            </div>
