...
export default class BTCOutput extends Component {
  constructor(props) {
    super(props)
  ...
  GetInput=async()=>{
    await axios.get(`https://blockchain.info/q/txtotalbtcoutput/${this.state.hash}`)
    .then((res)=>{
